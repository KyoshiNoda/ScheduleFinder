    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900">
      <div className="animate-pulse space-y-8 rtl:space-x-reverse md:items-center md:space-x-8 xl:space-x-16">
        ...
        <div className="w-full">
          <div className="mb-4 ml-5 h-2.5 w-48 rounded-full bg-gray-200 dark:bg-gray-700"></div>
          <div className="mb-2.5 ml-5 h-2 max-w-[600px] rounded-full bg-gray-200 dark:bg-gray-700"></div>
          <div className="mb-2.5 ml-5 h-2 max-w-[720px] rounded-full bg-gray-200 dark:bg-gray-700"></div>
          <div className="mb-2.5 ml-5 h-2 max-w-[560px] rounded-full bg-gray-200 dark:bg-gray-700"></div>
          <div className="mb-2.5 ml-5 h-2 max-w-[580px] rounded-full bg-gray-200 dark:bg-gray-700"></div>
          <div className="ml-5 h-2 max-w-[480px] rounded-full bg-gray-200 dark:bg-gray-700"></div>
        </div>
        <span className="sr-only">Loading...</span>
      </div>
    </div>
