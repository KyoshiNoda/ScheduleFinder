  ...
  return (
    <>
      ...
      >
        ...
        <button
          type="submit"
          className="block w-full bg-blue-400 p-3 rounded-xl text-center font-bold text-white first-letter:rounded-sm hover:bg-blue-600 dark:bg-slate-300 dark:text-gray-900 dark:hover:bg-slate-400"
        >
          Sign in
        </button>
      </form>
