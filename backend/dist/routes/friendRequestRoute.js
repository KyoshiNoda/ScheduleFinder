...
router.delete('/sent/:friendID', authenticateToken_1.authenticateToken, FriendController_1.default.cancelPendingFriendRequest);
router.post('/:friendID', authenticateToken_1.authenticateToken, FriendController_1.default.sendFriendRequest);
router.delete('/:friendID', authenticateToken_1.authenticateToken, FriendController_1.default.removeFriendRequest);
