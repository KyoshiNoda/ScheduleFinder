...
router.delete('/:id', AuthController_1.default.authenticateToken, ScheduleController_1.default.clearScheduleById);
...
router.get('/:id/user', ScheduleController_1.default.getScheduleByUserId);
