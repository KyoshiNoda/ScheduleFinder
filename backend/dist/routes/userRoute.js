...
router.patch('/', authenticateToken_1.authenticateToken, (0, validateRequest_1.validateRequest)({ body: schemas_1.updateUserBodySchema }), UserController_1.default.updateUser);
